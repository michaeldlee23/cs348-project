/*
    This script is used for generating the `generate-teachers.sql` script, which is then run by 
    `reset.sql` to populate the `teachers` table.
    
    Run this script before running `reset.sql`. It will also generate `teachers-password-map.txt` which
